...
Possui diversas funcionalidades eficazes e tratamentos de erro direcionando o usuário a utilizar corretamente o programa.

<img width="1920" height="1020" alt="image" src="https://github.com/user-attachments/assets/a6a4537f-6881-4882-bcc1-1c4023b96da9" />

A ideia do sistema é simples, ele adiciona alunos num array de objetos (alunos), onde é registrado nome, notas, e a média desse aluno (a média é calculada automaticamente), lista eles mostrando todos os alunos registrados e remove-os também. Tudo isso na primeira aba do sistema "Alunos".
